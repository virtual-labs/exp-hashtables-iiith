...
var check = function(method) {
  ...
  var answers;
  if (method === 'ht')
    answers = checker.answersHT;
  else if (method === 'lp')
    answers = checker.answersLP;
  else if (method === 'qp')
    answers = checker.answersQP;
  else if (method === 'dh')
    answers = checker.answersDH;
...
var newques = function() {
  ...
  if (checker.questionNumber === 9)
    checker.questionNumber = 1;
  if (checker.questionNumber === 1)
  {
    questionelement.innerHTML = "Insert 66, 80, 41, 44, 82, 89 and 45 in the given hash table.";
    if (method==='ht')
      checker.answersHT = checker.answersA;
    else if (method==='lp')
      checker.answersLP = checker.answersA;
    else if (method==='qp')
      checker.answersQP = checker.answersA;
    else if (method==='dh')
      checker.answersDH = checker.answersA;
  }
  else if (checker.questionNumber === 2)
  {
    questionelement.innerHTML = "Insert 82, 63, 41, 99, 94 and 45 in the given hash table.";
    if (method==='ht')
      checker.answersHT = checker.answersB;
    else if (method==='lp')
      checker.answersLP = checker.answersB;
    else if (method==='qp')
      checker.answersQP = checker.answersB;
    else if (method==='dh')
      checker.answersDH = checker.answersB;
  }
  else if (checker.questionNumber === 3)
  {
    questionelement.innerHTML = "Insert 70, 51, 43, 94, 77 and 79 in the given hash table.";
    if (method==='ht')
      checker.answersHT = checker.answersC;
    else if (method==='lp')
      checker.answersLP = checker.answersC;
    else if (method==='qp')
      checker.answersQP = checker.answersC;
    else if (method==='dh')
      checker.answersDH = checker.answersC;
  }
  else if (checker.questionNumber === 4)
  {
    questionelement.innerHTML = "Insert 50, 21, 73, 55, 88 and 89 in the given hash table.";
    if (method==='ht')
      checker.answersHT = checker.answersD;
    else if (method==='lp')
      checker.answersLP = checker.answersD;
    else if (method==='qp')
      checker.answersQP = checker.answersD;
    else if (method==='dh')
      checker.answersDH = checker.answersD;
  }
  else if (checker.questionNumber === 5)
  {
    questionelement.innerHTML = "Insert 0, 74, 11, 69, 96 and 15 in the given hash table.";
    if (method==='ht')
      checker.answersHT = checker.answersE;
    else if (method==='lp')
      checker.answersLP = checker.answersE;
    else if (method==='qp')
      checker.answersQP = checker.answersE;
    else if (method==='dh')
      checker.answersDH = checker.answersE;
  }
  else if (checker.questionNumber === 6)
  {
    questionelement.innerHTML = "Insert 53, 62, 11, 19, 74 and 65 in the given hash table.";
    if (method==='ht')
      checker.answersHT = checker.answersF;
    else if (method==='lp')
      checker.answersLP = checker.answersF;
    else if (method==='qp')
      checker.answersQP = checker.answersF;
    else if (method==='dh')
      checker.answersDH = checker.answersF;
  }
  else if (checker.questionNumber === 7)
  {
    questionelement.innerHTML = "Insert 70, 71, 73, 74, 75 and 76 in the given hash table.";
    if (method==='ht')
      checker.answersHT = checker.answersG;
    else if (method==='lp')
      checker.answersLP = checker.answersG;
    else if (method==='qp')
      checker.answersQP = checker.answersG;
    else if (method==='dh')
      checker.answersDH = checker.answersG;
  }
  else if (checker.questionNumber === 8)
  {
    questionelement.innerHTML = "Insert 32, 93, 44, 87, 98 and 19 in the given hash table.";
    if (method==='ht')
      checker.answersHT = checker.answersH;
    else if (method==='lp')
      checker.answersLP = checker.answersH;
    else if (method==='qp')
      checker.answersQP = checker.answersH;
    else if (method==='dh')
      checker.answersDH = checker.answersH;
  }
